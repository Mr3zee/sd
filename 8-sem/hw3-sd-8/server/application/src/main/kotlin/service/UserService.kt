...
class UserServiceImpl : UserService, KoinComponent {
    ...
    override suspend fun register(): Int {
        return UserTables.User.insertAndGetId {
            it[balance] = 0.0
        }.value
    }
    ...
    override suspend fun getPortfolio(id: Int): Portfolio {
        ...
        return UserTables.Portfolio.select {
    ...
    private fun updateStockAmount(id: Int, code: String, addStokeAmount: Int, newBalance: Double) {
